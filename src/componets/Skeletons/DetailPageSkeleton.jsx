...
export default function Details() {
  return (
    ...
    >
      <div className="w-full relative h-[480px] max-md:h-[300px] max-sm:h-[250px] rounded-[40px]  ">
      ...
      <div className="mt-28 flex justify-center max-md:flex-col max-sm:flex-col  h-[700px] max-md:h-full px-10 max-md:px-0 w-full items-center gap-20 max-md:gap-10 max-sm:gap-10">
        <div className="w-1/2 max-md:full max-sm:w-full h-full rounded-[35px] max-md:h-[400px]"></div>
