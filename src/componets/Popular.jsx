...
function Popular() {
  return (
    <div className="mt-12 px-28 flex flex-col max-sm:px-10 max-md:px-10 max-lg:px-16 bg-gradient-to-t from-[rgba(2,6,23,1)] via-[#040c2c] to-[rgba(2,6,23,1)] py-10 rounded-3xl bg-g">
